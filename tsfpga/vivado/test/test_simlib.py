...
class TestVivadoSimlibGhdl(TestCase):
    ...
    def test_ghdl_version_string(self):
        ...
        assert (
            ".ghdl_0_36_v0_36."
            in self.get_vivado_simlib(ghdl_version_string="GHDL 0.36 (v0.36)").artifact_name
        )
        assert ".ghdl_0_36" in self.get_vivado_simlib(ghdl_version_string="GHDL 0.36").artifact_name
