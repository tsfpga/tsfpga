...
class RegisterList:
    ...
    def _create_vhdl_package(self, vhd_file, self_hash):
        ...
        generated_info = f"{self.generated_info()} Register hash {self_hash}."
...
def from_toml(module_name, toml_file, default_registers=None):
    ...
    register_list = RegisterList(name=module_name, source_definition_file=toml_file)
