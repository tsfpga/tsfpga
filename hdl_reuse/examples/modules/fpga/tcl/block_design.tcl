...
proc create_root_design { parentCell } {
  ...
  set S_AXI_HP0_FPD [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI_HP0_FPD ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {32} \
  ...
  set saxihp0_fpd_aclk [ create_bd_port -dir I -type clk saxihp0_fpd_aclk ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRF_APB__DDR_CTRL__ACT_FREQMHZ {399.996000} \
   ...
   CONFIG.PSU__CRL_APB__DLL_REF_CTRL__ACT_FREQMHZ {999.990000} \
   ...
   CONFIG.PSU__CRL_APB__PCAP_CTRL__ACT_FREQMHZ {199.998000} \
   CONFIG.PSU__CRL_APB__PCAP_CTRL__DIVISOR0 {5} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {199.998000} \
  ...
  connect_bd_intf_net -intf_net S_AXI_HP0_FPD_1 [get_bd_intf_ports S_AXI_HP0_FPD] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_ports M_AXI_HPM0_FPD] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net maxihpm0_fpd_aclk_1 [get_bd_ports maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net saxihp0_fpd_aclk_1 [get_bd_ports saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_ports pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]

  # Create address segments
  create_bd_addr_seg -range 0x00100000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs M_AXI_HPM0_FPD/Reg] SEG_M_AXI_HPM0_FPD_Reg

  # Exclude Address Segments
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces S_AXI_HP0_FPD] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  exclude_bd_addr_seg [get_bd_addr_segs S_AXI_HP0_FPD/SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces S_AXI_HP0_FPD] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs S_AXI_HP0_FPD/SEG_zynq_ultra_ps_e_0_HP0_LPS_OCM]
